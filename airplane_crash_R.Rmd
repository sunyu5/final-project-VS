...
p <- ggplot(temp_full2, aes(x = Year))
  p <- p + geom_line(data = temp_full2, aes(y = Fatalities_num , colour = 'Fatalities'))
  ...
  p<- p + geom_line(data = temp_full,aes(y = numAcc*50, colour = 'Accidents'))
  #p <- p + geom_point(data = temp_full, aes(y = numAcc*50, colour = 'black'))
  # now adding the secondary axis, following the example in the help file ?scale_y_continuous
  # and, very important, reverting the above transformation
  p <- p + scale_y_continuous(name = "num_Fatalities", sec.axis =  sec_axis((~ . / 50), name = "num_ACC"))
...
ggplot(temp_loc, aes(x = Year, fill=Location))+geom_histogram(alpha = .5)+scale_x_continuous(breaks=seq(1970, 1979,1))
